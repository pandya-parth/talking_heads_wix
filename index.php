...
<head>
    ...
    <title>Talking Heads Wix App</title>
...
<body>
    <section class="container example">
        <div class="row">
            <div class="col-sm-6">
                <h3>Adding a Talking Head is EASY!</h3>
                <ul>
                    <li>Select your Script</li>
                    <li>Select your Actor</li>
                    <li>Set Player Settings</li>
                </ul>
                <p>
                    Welcome to the Website Talking Heads Wix App. With over 8 years’ experience in the Video Spokesperson website industry, we understand the business of Internet Video. We pride ourselves on our high quality and successful actors and actresses. Our videos are all shot and built here at our headquarters to maintain quality and precision. We do not outsource our filming to any other studios. It is all filmed HERE.
                </p>
                </ul>
            </div>
            <div class="col-sm-6">
    ...
    <script type="text/javascript" src="wthvideo/wthvideo-wixdemo.js"></script>
</body>
